...
resource "aws_lambda_function" "this" {
  count = var.create_function && !var.create_layer ? 1 : 0
...
data "aws_cloudwatch_log_group" "lambda" {
  count = var.create_function && !var.create_layer && var.use_existing_cloudwatch_log_group ? 1 : 0
...
resource "aws_lambda_provisioned_concurrency_config" "current_version" {
  count = var.create_function && !var.create_layer && var.provisioned_concurrent_executions > -1 ? 1 : 0
...
resource "aws_lambda_function_event_invoke_config" "this" {
  for_each = { for k, v in local.qualifiers : k => v if v != null && var.create_function && !var.create_layer && var.create_async_event_config }
...
resource "aws_lambda_permission" "current_version_triggers" {
  for_each = { for k, v in var.allowed_triggers : k => v if var.create_function && !var.create_layer && var.create_current_version_allowed_triggers }
...
resource "aws_lambda_permission" "unqualified_alias_triggers" {
  for_each = { for k, v in var.allowed_triggers : k => v if var.create_function && !var.create_layer && var.create_unqualified_alias_allowed_triggers }
...
resource "aws_lambda_event_source_mapping" "this" {
  for_each = { for k, v in var.event_source_mapping : k => v if var.create_function && !var.create_layer && var.create_unqualified_alias_allowed_triggers }
...
resource "aws_lambda_function_url" "this" {
  count = var.create_function && !var.create_layer && var.create_lambda_function_url ? 1 : 0
...
resource "null_resource" "sam_metadata_aws_lambda_function" {
  count = var.create_package && var.create_function && !var.create_layer ? 1 : 0
...
resource "null_resource" "sam_metadata_aws_lambda_layer_version" {
  count = var.create_package && var.create_layer ? 1 : 0
