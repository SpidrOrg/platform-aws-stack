...
variable "lambda_function_arn" {
  type        = string
  default     = ""
  description = "lambda function arn associate to resources"
}

variable "s3_bucket_arn" {
  type        = string
  default     = ""
  description = "s3 bucket arn associate to resources"
}
...
variable "s3_bucket" {
  type        = string
  default     = ""
  description = "s3 bucket associate to resources"
}

variable "filter_prefix" {
  type        = string
  default     = ""
  description = "s3 filter prefix associate to resources"
}

variable "filter_prefix_1" {
  type        = string
  default     = ""
  description = "s3 filter suffix associate to resources"
}
...
variable "statement_id" {
  type        = string
  default     = ""
  description = "s3 statement id associate to resources"
}
# ----------------------------------------------------------------------------------------------------------------------
