...
dependency "glue_transformation_job_role" {
  config_path = "../../../07-iam/02-glue-roles/02-fred"
  mock_outputs = {
...
inputs = merge(
  local.common_vars.inputs,
  {
    jobs = [
      {
        name                            = "transformation-fred"
        description                     = "Glue transformation job for source fred"
        glue_version                    = "3.0"
        python_version                  = "3.9"
        ...
        script_object_key               = "krny-spi-codebase-test/glue/python-shell-scripts/krny_trnsf_fred.py"
        default_arguments =         {
