    ...
    jobs = [
      {
        ...
        script_object_key               = "krny-spi-codebase-test/glue/python-shell-scripts/krny-meteostat.py"
        default_arguments =         {
                                "--enable-job-insights": "false",
                                "--job-language": "python",
                                "--job-type": "pythonshell",
                                "--TempDir": "s3://krny-spi-codebase-test/glue/python-shell-scripts/temp-dir/",
                                "--enable-glue-datacatalog": "true",
                                "--extra-py-files": "s3://krny-spi-codebase-test/glue/python-packages/meteostat-1.6.5-py3-none-any.whl",
                                "--library-set": "analytics",
                                "--bucket": "krny-spi-ext-sources-test",
                                ...
                                "--mapper": "s3://krny-spi-ext-sources-test/raw-data/meteostat/config/Mappedweatherstation_by_City.csv",         
                                "--dpu": "1"
                                }
      }
    ]                        
