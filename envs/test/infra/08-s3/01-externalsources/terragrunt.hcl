...
inputs = merge(
  ...
  {
    region                 = "us-east-1"
    bucket_name            = "krny-spi-ext-sources-test"
    force_destroy          = "true"
    attach_policy          = "true"
    deny_insecure          = "true"
    project                = "krny"
