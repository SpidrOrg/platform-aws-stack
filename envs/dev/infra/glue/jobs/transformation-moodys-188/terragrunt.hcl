...
inputs = merge(
  local.common_vars.inputs,
  {
    jobs = [
      {
        name                            = "transformation-moodys-188"
        description                     = "Glue transformation job for source moodys 188"
        glue_version                    = "3.0"
        python_version                  = "3.9"
        ...
        script_object_key               = "dev-krny-external-sources-tf/glue-python-shell-scripts/krny_trnsf_moodys_188.py"
        default_arguments =         {
