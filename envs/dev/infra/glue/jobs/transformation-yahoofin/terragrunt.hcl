...
dependency "glue_transformation_job_role" {
  config_path = "../../../iam/glue-roles/yahoofin"
  mock_outputs = {
    ...
    jobs = [
      {
        ...
        script_object_key               = "dev-krny-external-sources-tf/glue-python-shell-scripts/krny_trnsf_yahoofin.py"
        default_arguments =         {
                                ...
                                "--table_name": "dev_krny_yahoo_securities",
