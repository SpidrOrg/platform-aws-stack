...
dependency "glue_transformation_job_role" {
  config_path = "../../../iam/glue-roles/meteostat"
  mock_outputs = {
...
inputs = merge(
  local.common_vars.inputs,
  {
    jobs = [
      {
        name                            = "dev_krny_trnsf_meteostat_tf"
        ...
        script_object_key               = "dev-krny-external-sources-tf/glue-python-shell-scripts/dev_krny_trnsf_meteostat.py"
        default_arguments =         {
