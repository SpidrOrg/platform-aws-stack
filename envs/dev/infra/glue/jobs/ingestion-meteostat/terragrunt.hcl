    ...
    jobs = [
      {
        ...
        script_object_key               = "dev-krny-external-sources-tf/glue-python-shell-scripts/krny-meteostat.py"
        default_arguments =         {
                                "--enable-job-insights": "false",
                                "--job-language": "python",
                                "--job-type": "pythonshell",
                                "--TempDir": "s3://dev-krny-external-sources-tf/python-shell-scripts/temp-dir/",
