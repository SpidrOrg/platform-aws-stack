...
dependency "glue_transformation_job_role" {
  config_path = "../../../iam/glue-roles/moodys"
  mock_outputs = {
...
inputs = merge(
  local.common_vars.inputs,
  {
    jobs = [
      {
        name                            = "dev_krny_trnsf_moodys_tf"
        description                     = "Glue transformation job for source moodys"
        glue_version                    = "3.0"
        python_version                  = "3.9"
        ...
        script_object_key               = "dev-krny-external-sources-tf/glue-python-shell-scripts/dev_krny_trnsf_moodys.py"
        default_arguments =         {
                                ...
                                "--folder": "raw-data/moodys",
                                "--crawler_cleaneddata": "crawler-cleaneddata-krny",
                                "--crawler_transformeddata": "crawler-transformeddata-krny",
                                "--mapper": "variable-treatment-file-mapper/variable treatment and category.xlsx",                                "--folder": "raw-data/moodys"
                                }
      }
    ]                        
  },
