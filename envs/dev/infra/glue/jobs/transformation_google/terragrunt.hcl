...
dependency "glue_transformation_job_role" {
  config_path = "../../../iam/glue-roles/google"
  mock_outputs = {
    ...
    jobs = [
      {
        ...
        script_object_key               = "dev-krny-external-sources-tf/glue-python-shell-scripts/dev_krny_trnsf_google.py"
        default_arguments =         {
